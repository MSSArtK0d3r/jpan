...
<div class="contents eight columns">
    ...
    <form action="{{route('updateSectionJ')}}" method="POST">
        ...
        <div class="introPage <x-form-validation-error key='J1'/>" style="margin-bottom: 10px;">
            ...
            <x-ratings-components initialQuestion="0" :completedR="$userProgress[0]->completedR" questionNumber="1" sectionQuestion="J" :userData="$userData[0]->J1"/>
         </div>
         <div class="introPage <x-form-validation-error key='J2'/>" style="margin-bottom: 10px;">
            <p>2. Tidak berdaya saing.</p>
            <x-ratings-components initialQuestion="0" :completedR="$userProgress[0]->completedR" questionNumber="2" sectionQuestion="J" :userData="$userData[0]->J2"/>
         </div>
         <div class="introPage <x-form-validation-error key='J3'/>" style="margin-bottom: 10px;">
            ...
            <x-ratings-components initialQuestion="0" :completedR="$userProgress[0]->completedR" questionNumber="3" sectionQuestion="J" :userData="$userData[0]->J3"/>
            
         </div>
         <div class="introPage <x-form-validation-error key='J4'/>" style="margin-bottom: 10px;">
            <p>4. Menyatakan perasaan secara terbuka.</p>
            <x-ratings-components initialQuestion="0" :completedR="$userProgress[0]->completedR" questionNumber="4" sectionQuestion="J" :userData="$userData[0]->J4"/>
         </div>
         <div class="introPage <x-form-validation-error key='J5'/>" style="margin-bottom: 10px;">
            ...
            <x-ratings-components initialQuestion="0" :completedR="$userProgress[0]->completedR" questionNumber="5" sectionQuestion="J" :userData="$userData[0]->J5"/>
         </div>
         <div class="introPage <x-form-validation-error key='J6'/>" style="margin-bottom: 10px;">
            ...
            <x-ratings-components initialQuestion="0" :completedR="$userProgress[0]->completedR" questionNumber="6" sectionQuestion="J" :userData="$userData[0]->J6"/>
         </div>
         <div class="introPage <x-form-validation-error key='J7'/>" style="margin-bottom: 10px;">
            <p>7. Mudah bergaul.</p>
            <x-ratings-components initialQuestion="0" :completedR="$userProgress[0]->completedR" questionNumber="7" sectionQuestion="J" :userData="$userData[0]->J7"/>
         </div>
         <div class="introPage <x-form-validation-error key='J8'/>" style="margin-bottom: 10px;">
            ...
            <x-ratings-components initialQuestion="0" :completedR="$userProgress[0]->completedR" questionNumber="8" sectionQuestion="J" :userData="$userData[0]->J8"/>
         </div>
         <div class="introPage <x-form-validation-error key='J9'/>" style="margin-bottom: 10px;">
            <p>9. Lambat dalam melakukan sesuatu perkara.</p>
            <x-ratings-components initialQuestion="0" :completedR="$userProgress[0]->completedR" questionNumber="9" sectionQuestion="J" :userData="$userData[0]->J9"/>
         </div>
         <div class="introPage <x-form-validation-error key='J10'/>" style="margin-bottom: 10px;">
            <p>10. Tidak begitu teliti.</p>
            <x-ratings-components initialQuestion="0" :completedR="$userProgress[0]->completedR" questionNumber="10" sectionQuestion="J" :userData="$userData[0]->J10"/>
         </div>
