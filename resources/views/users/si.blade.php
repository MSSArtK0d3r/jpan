...
<div class="contents eight columns">
    ...
    <form action="{{route('updateSectionI')}}" method="POST">
        ...
        <div class="introPage <x-form-validation-error key='I1'/>" style="margin-bottom: 10px;">
            ...
            <x-ratings-components initialQuestion="0" :completedR="userData[0]->completedR" questionNumber="1" sectionQuestion="I" :userData="$userData[0]->I1"/> 
         </div>
         <div class="introPage <x-form-validation-error key='I2'/>" style="margin-bottom: 10px;">
            ...
            <x-ratings-components initialQuestion="0" :completedR="userData[0]->completedR" questionNumber="2" sectionQuestion="I" :userData="$userData[0]->I2"/>
         </div>
         <div class="introPage <x-form-validation-error key='I3'/>" style="margin-bottom: 10px;">
            ...
            <x-ratings-components initialQuestion="0" :completedR="userData[0]->completedR" questionNumber="3" sectionQuestion="I" :userData="$userData[0]->I3"/>
         </div>
