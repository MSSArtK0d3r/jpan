...
<div class="contents eight columns">
    ...
    <div class="introPage <x-form-validation-error key='M1'/>" style="margin-bottom: 10px;">
        ...
        <x-ratings-components initialQuestion="0" :completedR="$userProgress[0]->completedR" questionNumber="1" sectionQuestion="M" :userData="$userData[0]->M1"/> 
     </div>
     <div class="introPage <x-form-validation-error key='M2'/>" style="margin-bottom: 10px;">
        ...
        <x-ratings-components initialQuestion="0" :completedR="$userProgress[0]->completedR" questionNumber="2" sectionQuestion="M" :userData="$userData[0]->M2"/> 
     </div>
     <div class="introPage <x-form-validation-error key='M3'/>" style="margin-bottom: 10px;">
        <p>3. Komuniti di tempat saya adalah baik.</p>
        <x-ratings-components initialQuestion="0" :completedR="$userProgress[0]->completedR" questionNumber="3" sectionQuestion="M" :userData="$userData[0]->M3"/> 
     </div>
