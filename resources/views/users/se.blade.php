...
<div class="contents eight columns">
    ...
    <form action="{{route('updateSectionE')}}" method="POST">
        ...
        <div class="introPage <x-form-validation-error key='E1'/>" style="margin-bottom: 10px;">
            ...
            <x-ratings-components initialQuestion="0" :completedR="userData[0]->completedR" questionNumber="1" sectionQuestion="E" :userData="$userData[0]->E1"/>
         </div>
         <div class="introPage <x-form-validation-error key='E2'/>" style="margin-bottom: 10px;">
            <p>2. Saya selalu aktif melakukan pekerjaan.</p>
            <x-ratings-components initialQuestion="0" :completedR="userData[0]->completedR" questionNumber="2" sectionQuestion="E" :userData="$userData[0]->E2"/>
         </div>
         <div class="introPage <x-form-validation-error key='E3'/>" style="margin-bottom: 10px;">
            ...
            <x-ratings-components initialQuestion="0" :completedR="userData[0]->completedR" questionNumber="3" sectionQuestion="E" :userData="$userData[0]->E3"/>
         </div>
         <div class="introPage <x-form-validation-error key='E4'/>" style="margin-bottom: 10px;">
            <p>4. Saya kecewa dengan pekerjaan saya.</p>
            <x-ratings-components initialQuestion="0" :completedR="userData[0]->completedR" questionNumber="4" sectionQuestion="E" :userData="$userData[0]->E4"/>
         </div>
         <div class="introPage <x-form-validation-error key='E5'/>" style="margin-bottom: 10px;">
            ...
            <x-ratings-components initialQuestion="0" :completedR="userData[0]->completedR" questionNumber="5" sectionQuestion="E" :userData="$userData[0]->E5"/>
         </div>
         <div class="introPage <x-form-validation-error key='E6'/>" style="margin-bottom: 10px;">
            ...
            <x-ratings-components initialQuestion="0" :completedR="userData[0]->completedR" questionNumber="6" sectionQuestion="E" :userData="$userData[0]->E6"/>
         </div>
