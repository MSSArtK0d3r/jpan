...
<div class="contents eight columns">
    ...
    <form action="{{route('updateSectionB')}}" method="POST" onsubmit="this.querySelectorAll('input').forEach(i => i.disabled = false)">
        @csrf
        <div class="introPage <x-form-validation-error :key='$userData[0]->filledB' :index='$userData[0]->B1'/>" style="margin-bottom: 10px;">
         ...
         @if ($penilai[0]->penilai == 2)
            <div class="introPage <x-form-validation-error :key='$userData[0]->filledB' :index='$userData[0]->B5'/>" id="penilai2" style="margin-bottom: 10px;">
         ...
         <div class="introPage <x-form-validation-error :key='$userData[0]->filledB' :index='$userData[0]->B6'/>" style="margin-bottom: 10px;">
         ...
         <div class="introPage <x-form-validation-error :key='$userData[0]->filledB' :index='$userData[0]->B7'/>" style="margin-bottom: 10px;">
         ...
         <div class="introPage <x-form-validation-error :key='$userData[0]->filledB' :index='$userData[0]->B8'/>" style="margin-bottom: 10px;">
         ...
         <div class="introPage <x-form-validation-error :key='$userData[0]->filledB' :index='$userData[0]->B9'/>" style="margin-bottom: 10px;">
         ...
         <div class="introPage <x-form-validation-error :key='$userData[0]->filledB' :index='$userData[0]->B10'/>" style="margin-bottom: 10px;">
         ...
         <div class="introPage <x-form-validation-error :key='$userData[0]->filledB' :index='$userData[0]->B11'/>" style="margin-bottom: 10px;">
         ...
         <div class="introPage <x-form-validation-error :key='$userData[0]->filledB' :index='$userData[0]->B12'/>" style="margin-bottom: 10px;">
         ...
         <div class="introPage <x-form-validation-error :key='$userData[0]->filledB' :index='$userData[0]->B13'/>" style="margin-bottom: 10px;">
         ...
         <div class="introPage <x-form-validation-error :key='$userData[0]->filledB' :index='$userData[0]->B14'/>" style="margin-bottom: 10px;">
         ...
         <div class="introPage <x-form-validation-error :key='$userData[0]->filledB' :index='$userData[0]->B15'/>" style="margin-bottom: 10px;">
         ...
         <div class="introPage <x-form-validation-error :key='$userData[0]->filledB' :index='$userData[0]->B16'/>" style="margin-bottom: 10px;">
         ...
         <div class="introPage <x-form-validation-error :key='$userData[0]->filledB' :index='$userData[0]->B17'/>" style="margin-bottom: 10px;">
         ...
         <div class="introPage <x-form-validation-error :key='$userData[0]->filledB' :index='$userData[0]->B18'/>" style="margin-bottom: 10px;">
