    ...
    <form action="{{route('updateSectionB')}}" method="POST" onsubmit="this.querySelectorAll('input').forEach(i => i.disabled = false)">
        ...
        <div class="introPage <x-form-validation-error key='B1'/>" style="margin-bottom: 10px;">
            <p>1. Saya berasa dibayar dengan gaji yang setimpal dengan kerja yang saya lakukan.</p>
                <x-ratings-components initialQuestion="0" :completedR="$userProgress[0]->completedR" questionNumber="1" sectionQuestion="B" :userData="$userData[0]->B1"/>
         </div>
         <div class="introPage <x-form-validation-error key='B3'/>" style="margin-bottom: 10px;">
            ...
            <x-ratings-components initialQuestion="0" :completedR="$userProgress[0]->completedR" questionNumber="2" sectionQuestion="B" :userData="$userData[0]->B3"/>
         </div>
         <div class="introPage <x-form-validation-error key='B2'/>" style="margin-bottom: 10px;">
            ...
            <x-ratings-components initialQuestion="0" :completedR="$userProgress[0]->completedR" questionNumber="3" sectionQuestion="B" :userData="$userData[0]->B2"/>
         </div>
         <div class="introPage <x-form-validation-error key='B4'/>" style="margin-bottom: 10px;">
            ...
            <x-ratings-components initialQuestion="0" :completedR="$userProgress[0]->completedR" questionNumber="4" sectionQuestion="B" :userData="$userData[0]->B4"/>
         </div>
         @if ($penilai[0]->penilai == 2)
            ...
            <x-ratings-components initialQuestion="0" :completedR="$userProgress[0]->completedR" questionNumber="5" sectionQuestion="B" :userData="$userData[0]->B5"/>
            </div>
         @else
            <div class="introPage <x-form-validation-error key='B5'/>" id="penilai2" style="margin-bottom: 10px;">
         ...
         <div class="introPage <x-form-validation-error key='B6'/>" style="margin-bottom: 10px;">
            ...
            <x-ratings-components initialQuestion="0" :completedR="$userProgress[0]->completedR" questionNumber="6" sectionQuestion="B" :userData="$userData[0]->B6"/>
         ...
         <div class="introPage <x-form-validation-error key='B7'/>" style="margin-bottom: 10px;">
            ...
            <x-ratings-components initialQuestion="0" :completedR="$userProgress[0]->completedR" questionNumber="7" sectionQuestion="B" :userData="$userData[0]->B7"/>
         ...
         <div class="introPage <x-form-validation-error key='B8'/>" style="margin-bottom: 10px;">
            ...
            <x-ratings-components initialQuestion="0" :completedR="$userProgress[0]->completedR" questionNumber="8" sectionQuestion="B" :userData="$userData[0]->B8"/>
         ...
         <div class="introPage <x-form-validation-error key='B9'/>" style="margin-bottom: 10px;">
            ...
            <x-ratings-components initialQuestion="0" :completedR="$userProgress[0]->completedR" questionNumber="9" sectionQuestion="B" :userData="$userData[0]->B9"/>
         ...
         <div class="introPage <x-form-validation-error key='B10'/>" style="margin-bottom: 10px;">
            ...
            <x-ratings-components initialQuestion="0" :completedR="$userProgress[0]->completedR" questionNumber="10" sectionQuestion="B" :userData="$userData[0]->B10"/>
         ...
         <div class="introPage <x-form-validation-error key='B11'/>" style="margin-bottom: 10px;">
            ...
            <x-ratings-components initialQuestion="0" :completedR="$userProgress[0]->completedR" questionNumber="11" sectionQuestion="B" :userData="$userData[0]->B11"/>
         ...
         <div class="introPage <x-form-validation-error key='B12'/>" style="margin-bottom: 10px;">
            ...
            <x-ratings-components initialQuestion="0" :completedR="$userProgress[0]->completedR" questionNumber="12" sectionQuestion="B" :userData="$userData[0]->B12"/>
            
         </div>
         <div class="introPage <x-form-validation-error key='B13'/>" style="margin-bottom: 10px;">
            <p>13. Pekerjaan saya menyeronokkan.</p>
            
            <x-ratings-components initialQuestion="0" :completedR="$userProgress[0]->completedR" questionNumber="13" sectionQuestion="B" :userData="$userData[0]->B13"/>
         ...
         <div class="introPage <x-form-validation-error key='B14'/>" style="margin-bottom: 10px;">
            ...
            <x-ratings-components initialQuestion="0" :completedR="$userProgress[0]->completedR" questionNumber="14" sectionQuestion="B" :userData="$userData[0]->B14"/>
         ...
         <div class="introPage <x-form-validation-error key='B15'/>" style="margin-bottom: 10px;">
            ...
            <x-ratings-components initialQuestion="0" :completedR="$userProgress[0]->completedR" questionNumber="15" sectionQuestion="B" :userData="$userData[0]->B15"/>
         ...
         <div class="introPage <x-form-validation-error key='B16'/>" style="margin-bottom: 10px;">
            ...
            <x-ratings-components initialQuestion="0" :completedR="$userProgress[0]->completedR" questionNumber="16" sectionQuestion="B" :userData="$userData[0]->B16"/>
         ...
         <div class="introPage <x-form-validation-error key='B17'/>" style="margin-bottom: 10px;">
            ...
            <x-ratings-components initialQuestion="0" :completedR="$userProgress[0]->completedR" questionNumber="17" sectionQuestion="B" :userData="$userData[0]->B17"/>
         ...
         <div class="introPage <x-form-validation-error key='B18'/>" style="margin-bottom: 10px;">
            ...
            <div class="ratingContainer">
                <x-ratings-components initialQuestion="0" :completedR="$userProgress[0]->completedR" questionNumber="18" sectionQuestion="B" :userData="$userData[0]->B18"/>
            </div>
         </div>
