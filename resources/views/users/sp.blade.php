...
<div class="contents eight columns">
    ...
    <div class="introPage <x-form-validation-error key='P1'/>" style="margin-bottom: 10px;">
        ...
        <x-ratings-components initialQuestion="0" :completedR="userData[0]->completedR" questionNumber="1" sectionQuestion="P" :userData="$userData[0]->P1"/>
     </div>
     <div class="introPage <x-form-validation-error key='P2'/>" style="margin-bottom: 10px;">
        ...
        <x-ratings-components initialQuestion="0" :completedR="userData[0]->completedR" questionNumber="2" sectionQuestion="P" :userData="$userData[0]->P2"/>
     </div>
