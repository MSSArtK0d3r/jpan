...
<div class="contents eight columns">
    ...
    <div class="introPage <x-form-validation-error key='K1'/>" style="margin-bottom: 10px;">
        ...
        <x-ratings-components initialQuestion="0" :completedR="userData[0]->completedR" questionNumber="1" sectionQuestion="K" :userData="$userData[0]->K1"/>
     </div>
     <div class="introPage <x-form-validation-error key='K2'/>" style="margin-bottom: 10px;">
        ...
        <x-ratings-components initialQuestion="0" :completedR="userData[0]->completedR" questionNumber="2" sectionQuestion="K" :userData="$userData[0]->K2"/>
     </div>
     <div class="introPage <x-form-validation-error key='K3'/>" style="margin-bottom: 10px;">
        ...
        <x-ratings-components initialQuestion="0" :completedR="userData[0]->completedR" questionNumber="3" sectionQuestion="K" :userData="$userData[0]->K3"/>
     </div>
     <div class="introPage <x-form-validation-error key='K4'/>" style="margin-bottom: 10px;">
        ...
        <x-ratings-components initialQuestion="0" :completedR="userData[0]->completedR" questionNumber="4" sectionQuestion="K" :userData="$userData[0]->K4"/>
     ...
     <div class="introPage <x-form-validation-error key='K5'/>" style="margin-bottom: 10px;">
        ...
        <x-ratings-components initialQuestion="0" :completedR="userData[0]->completedR" questionNumber="5" sectionQuestion="K" :userData="$userData[0]->K5"/>
     </div>
     <div class="introPage <x-form-validation-error key='K6'/>" style="margin-bottom: 10px;">
        ...
        <x-ratings-components initialQuestion="0" :completedR="userData[0]->completedR" questionNumber="6" sectionQuestion="K" :userData="$userData[0]->K6"/>
     </div>
     <div class="introPage <x-form-validation-error key='K7'/>" style="margin-bottom: 10px;">
        ...
        <x-ratings-components initialQuestion="0" :completedR="userData[0]->completedR" questionNumber="7" sectionQuestion="K" :userData="$userData[0]->K7"/>
     ...
     <div class="introPage <x-form-validation-error key='K8'/>" style="margin-bottom: 10px;">
        ...
        <x-ratings-components initialQuestion="0" :completedR="userData[0]->completedR" questionNumber="8" sectionQuestion="K" :userData="$userData[0]->K8"/>
     ...
     <div class="introPage <x-form-validation-error key='K9'/>" style="margin-bottom: 10px;">
        ...
        <x-ratings-components initialQuestion="0" :completedR="userData[0]->completedR" questionNumber="9" sectionQuestion="K" :userData="$userData[0]->K9"/>
     </div>
     <div class="introPage <x-form-validation-error key='K10'/>" style="margin-bottom: 10px;">
        ...
        <x-ratings-components initialQuestion="0" :completedR="userData[0]->completedR" questionNumber="10" sectionQuestion="K" :userData="$userData[0]->K10"/>
     </div>
