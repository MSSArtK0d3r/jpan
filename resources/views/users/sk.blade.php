...
<div class="contents eight columns">
    ...
    <div class="introPage <x-form-validation-error :key='$userData[0]->filledK' :index='$userData[0]->K1'/>" style="margin-bottom: 10px;">
     ...
     <div class="introPage <x-form-validation-error :key='$userData[0]->filledK' :index='$userData[0]->K3'/>" style="margin-bottom: 10px;">
     ...
     <div class="introPage <x-form-validation-error :key='$userData[0]->filledK' :index='$userData[0]->K4'/>" style="margin-bottom: 10px;">
     ...
     <div class="introPage <x-form-validation-error :key='$userData[0]->filledK' :index='$userData[0]->K5'/>" style="margin-bottom: 10px;">
     ...
     <div class="introPage <x-form-validation-error :key='$userData[0]->filledK' :index='$userData[0]->K6'/>" style="margin-bottom: 10px;">
     ...
     <div class="introPage <x-form-validation-error :key='$userData[0]->filledK' :index='$userData[0]->K7'/>" style="margin-bottom: 10px;">
     ...
     <div class="introPage <x-form-validation-error :key='$userData[0]->filledK' :index='$userData[0]->K8'/>" style="margin-bottom: 10px;">
     ...
     <div class="introPage <x-form-validation-error :key='$userData[0]->filledK' :index='$userData[0]->K9'/>" style="margin-bottom: 10px;">
     ...
     <div class="introPage <x-form-validation-error :key='$userData[0]->filledK' :index='$userData[0]->K10'/>" style="margin-bottom: 10px;">
