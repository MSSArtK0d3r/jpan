...
<div class="contents eight columns">
    ...
    <form action="{{route('updateSectionH1')}}" method="POST">
        @csrf
        <div class="introPage <x-form-validation-error :key='$userData[0]->filledH1' :index='$userData[0]->H1'/>" style="margin-bottom: 10px;">
         ...
         <div class="introPage <x-form-validation-error :key='$userData[0]->filledH1' :index='$userData[0]->H2'/>" style="margin-bottom: 10px;">
         ...
         <div class="introPage <x-form-validation-error :key='$userData[0]->filledH1' :index='$userData[0]->H3'/>" style="margin-bottom: 10px;">
         ...
         <div class="introPage <x-form-validation-error :key='$userData[0]->filledH1' :index='$userData[0]->H4'/>" style="margin-bottom: 10px;">
         ...
         <div class="introPage <x-form-validation-error :key='$userData[0]->filledH1' :index='$userData[0]->H5'/>" style="margin-bottom: 10px;">
         ...
         <div class="introPage <x-form-validation-error :key='$userData[0]->filledH1' :index='$userData[0]->H6'/>" style="margin-bottom: 10px;">
         ...
         <div class="introPage <x-form-validation-error :key='$userData[0]->filledH1' :index='$userData[0]->H7'/>" style="margin-bottom: 10px;">
         ...
         <div class="introPage <x-form-validation-error :key='$userData[0]->filledH1' :index='$userData[0]->H8'/>" style="margin-bottom: 10px;">
         ...
         <div class="introPage <x-form-validation-error :key='$userData[0]->filledH1' :index='$userData[0]->H9'/>" style="margin-bottom: 10px;">
         ...
         <div class="introPage <x-form-validation-error :key='$userData[0]->filledH1' :index='$userData[0]->H10'/>" style="margin-bottom: 10px;">
         ...
         <div class="introPage <x-form-validation-error :key='$userData[0]->filledH1' :index='$userData[0]->H11'/>" style="margin-bottom: 10px;">
         ...
         <div class="introPage <x-form-validation-error :key='$userData[0]->filledH1' :index='$userData[0]->H12'/>" style="margin-bottom: 10px;">
