...
<div class="contents eight columns">
    ...
    <form action="{{route('updateSectionH1')}}" method="POST">
        ...
        <div class="introPage <x-form-validation-error key='H1'/>" style="margin-bottom: 10px;">
            ...
            <x-ratings-components initialQuestion="0" :completedR="$userProgress[0]->completedR" questionNumber="1" sectionQuestion="H" :userData="$userData[0]->H1"/> 
        </div>
         <div class="introPage <x-form-validation-error key='H2'/>" style="margin-bottom: 10px;">
            ...
            <x-ratings-components initialQuestion="0" :completedR="$userProgress[0]->completedR" questionNumber="2" sectionQuestion="H" :userData="$userData[0]->H2"/> 
         </div>
         <div class="introPage <x-form-validation-error key='H3'/>" style="margin-bottom: 10px;">
            ...
            <x-ratings-components initialQuestion="0" :completedR="$userProgress[0]->completedR" questionNumber="3" sectionQuestion="H" :userData="$userData[0]->H3"/> 
         </div>
         <div class="introPage <x-form-validation-error key='H4'/>" style="margin-bottom: 10px;">
            ...
            <x-ratings-components initialQuestion="0" :completedR="$userProgress[0]->completedR" questionNumber="4" sectionQuestion="H" :userData="$userData[0]->H4"/> 
         </div>
         <div class="introPage <x-form-validation-error key='H5'/>" style="margin-bottom: 10px;">
            ...
            <x-ratings-components initialQuestion="0" :completedR="$userProgress[0]->completedR" questionNumber="5" sectionQuestion="H" :userData="$userData[0]->H5"/> 
         </div>
         <div class="introPage <x-form-validation-error key='H6'/>" style="margin-bottom: 10px;">
            ...
            <x-ratings-components initialQuestion="0" :completedR="$userProgress[0]->completedR" questionNumber="6" sectionQuestion="H" :userData="$userData[0]->H6"/> 
         </div>
         <div class="introPage <x-form-validation-error key='H7'/>" style="margin-bottom: 10px;">
            ...
            <x-ratings-components initialQuestion="0" :completedR="$userProgress[0]->completedR" questionNumber="7" sectionQuestion="H" :userData="$userData[0]->H7"/> 
         </div>
         <div class="introPage <x-form-validation-error key='H8'/>" style="margin-bottom: 10px;">
            ...
            <x-ratings-components initialQuestion="0" :completedR="$userProgress[0]->completedR" questionNumber="8" sectionQuestion="H" :userData="$userData[0]->H8"/> 
         </div>
         <div class="introPage <x-form-validation-error key='H9'/>" style="margin-bottom: 10px;">
            ...
            <x-ratings-components initialQuestion="0" :completedR="$userProgress[0]->completedR" questionNumber="9" sectionQuestion="H" :userData="$userData[0]->H9"/> 
         </div>
         <div class="introPage <x-form-validation-error key='H10'/>" style="margin-bottom: 10px;">
            ...
            <x-ratings-components initialQuestion="0" :completedR="$userProgress[0]->completedR" questionNumber="10" sectionQuestion="H" :userData="$userData[0]->H10"/> 
         </div>
         <div class="introPage <x-form-validation-error key='H11'/>" style="margin-bottom: 10px;">
            ...
            <x-ratings-components initialQuestion="0" :completedR="$userProgress[0]->completedR" questionNumber="11" sectionQuestion="H" :userData="$userData[0]->H11"/> 
         </div>
         <div class="introPage <x-form-validation-error key='H12'/>" style="margin-bottom: 10px;">
            ...
            <x-ratings-components initialQuestion="0" :completedR="$userProgress[0]->completedR" questionNumber="12" sectionQuestion="H" :userData="$userData[0]->H12"/> 
         </div>
