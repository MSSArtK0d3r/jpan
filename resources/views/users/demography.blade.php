            ...
            <label>1. Umur :</label>
                  ...
                  <div class="introPage <x-form-validation-error :key='$userData[0]->filledA' :index='$userData[0]->agama'/>" style="margin-bottom: 10px;">
                     <label>3. Agama :</label><br>
                        ...
                        <input {{$userProgress[0]->completedR == 1 ? 'disabled' : ''}} type="radio" onclick="clearInput('lainAgamaInput')" id="Kristian" name="agama" value="Kristian" {{ $userData[0]->agama == 'Kristian' ? 'checked' : '' }}>
                        <label class="inBlock" for="Kristian">Kristian</label><br>
                        <input {{$userProgress[0]->completedR == 1 ? 'disabled' : ''}} type="radio" onclick="clearInput('lainAgamaInput')" id="Buddha" name="agama" value="Buddha" {{ $userData[0]->agama == 'Buddha' ? 'checked' : '' }}>
                        <label class="inBlock" for="Buddha">Buddha</label><br>
                        <input {{$userProgress[0]->completedR == 1 ? 'disabled' : ''}} type="radio" onclick="clearInput('lainAgamaInput')" id="Hindu" name="agama" value="Hindu" {{ $userData[0]->agama == 'Hindu' ? 'checked' : '' }}>
                  ...
                  <div class="introPage <x-form-validation-error :key='$userData[0]->filledA' :index='$userData[0]->status'/>" style="margin-bottom: 10px;">
                     ...
                     <input {{$userProgress[0]->completedR == 1 ? 'disabled' : ''}} type="radio" id="Berkahwin" name="status" value="Berkahwin" {{$userData[0]->status == 'Berkahwin' ? 'checked' : ''}}>
                     <label class="inBlock" for="Berkahwin">Berkahwin</label><br>
                     <input {{$userProgress[0]->completedR == 1 ? 'disabled' : ''}} type="radio" id="Duda" name="status" value="Duda" {{$userData[0]->status == 'Duda' ? 'checked' : ''}}>
                     <label class="inBlock" for="Duda">Duda</label><br>
                     <input {{$userProgress[0]->completedR == 1 ? 'disabled' : ''}} type="radio" id="Janda" name="status" value="Janda" {{$userData[0]->status == 'Jandi' ? 'checked' : ''}}>
                     <label class="inBlock" for="Janda">Janda</label><br>
                     <input {{$userProgress[0]->completedR == 1 ? 'disabled' : ''}} type="radio" id="Balu" name="status" value="Balu" {{$userData[0]->status == 'Balu' ? 'checked' : ''}}>
                  ...
                  <div class="introPage <x-form-validation-error :key='$userData[0]->filledA' :index='$userData[0]->education'/>" style="margin-bottom: 10px;">
                     ...
                     <input {{$userProgress[0]->completedR == 1 ? 'disabled' : ''}} type="radio" id="PMR/SRP" name="education" value="PMR/SRP" {{ $userData[0]->education == 'PMR/SRP' ? 'checked' : '' }}>
                     <label class="inBlock" for="PMR/SRP">PMR/SRP</label><br>
                     <input {{$userProgress[0]->completedR == 1 ? 'disabled' : ''}} type="radio" id="SPM/Setara" name="education" value="SPM/Setara" {{ $userData[0]->education == 'SPM/Setara' ? 'checked' : '' }}>
                     <label class="inBlock" for="SPM/Setara">SPM/Setara</label><br>
                     <input {{$userProgress[0]->completedR == 1 ? 'disabled' : ''}} type="radio" id="STPM/Setara" name="education" value="STPM/Setara" {{ $userData[0]->education == 'STPM/Setara' ? 'checked' : '' }}>
                     <label class="inBlock" for="STPM/Setara">STPM/Setara</label><br>
                     <input {{$userProgress[0]->completedR == 1 ? 'disabled' : ''}} type="radio" id="Diploma" name="education" value="Diploma" {{ $userData[0]->education == 'Diploma' ? 'checked' : '' }}>
                     <label class="inBlock" for="Diploma">Diploma</label><br>
                     <input {{$userProgress[0]->completedR == 1 ? 'disabled' : ''}} type="radio" id="SarjanaMuda" name="education" value="Sarjana Muda" {{ $userData[0]->education == 'Sarjana Muda' ? 'checked' : '' }}>
                     <label class="inBlock" for="SarjanaMuda">Sarjana Muda</label><br>
                     <input {{$userProgress[0]->completedR == 1 ? 'disabled' : ''}} type="radio" id="Sarjana" name="education" value="Sarjana" {{ $userData[0]->education == 'Sarjana' ? 'checked' : '' }}>
                  ...
                  <div class="introPage <x-form-validation-error :key='$userData[0]->filledA' :index='$userData[0]->agensi'/>" style="margin-bottom: 10px;">
                     ...
                     <select {{$userProgress[0]->completedR == 1 ? 'disabled' : ''}} name="agensi" class="selectBox">
                        @if ( $userData[0]->agensi == NULL )
                           <option value="" selected disabled>Sila pilih</option><option value="Pejabat Yang Dipertua Negeri Sabah / Istana Negeri">Pejabat Yang Dipertua Negeri Sabah / Istana Negeri</option><option value="Pejabat Ketua Menteri">Pejabat Ketua Menteri</option><option value="Pejabat Setiausaha Kerajaan Negeri">Pejabat Setiausaha Kerajaan Negeri</option><option value="Kementerian Pembangunan Luar Bandar">Kementerian Pembangunan Luar Bandar</option><option value="Kementerian Kewangan">Kementerian Kewangan</option><option value="Kementerian Pertanian dan Perikanan">Kementerian Pertanian dan Perikanan</option><option value="Kementerian Kerja Raya">Kementerian Kerja Raya</option><option value="Kementerian Kerajaan Tempatan dan Perumahan">Kementerian Kerajaan Tempatan dan Perumahan</option><option value="Kementerian Pembangunan Masyarakat dan Kesejahteraan Rakyat">Kementerian Pembangunan Masyarakat dan Kesejahteraan Rakyat</option><option value="Kementerian Pelancongan, Kebudayaan dan Alam Sekitar">Kementerian Pelancongan, Kebudayaan dan Alam Sekitar</option><option value="Kementerian Pembangunan Perindustrian">Kementerian Pembangunan Perindustrian</option><option value="Kementerian Belia dan Sukan Sabah">Kementerian Belia dan Sukan Sabah</option><option value="Kementerian Sains, Teknologi dan Inovasi">Kementerian Sains, Teknologi dan Inovasi</option><option value="Pejabat Dewan Undangan Negeri">Pejabat Dewan Undangan Negeri</option><option value="Suruhanjaya Perkhidmatan Awam Negeri">Suruhanjaya Perkhidmatan Awam Negeri</option><option value="Pejabat Timbalan Setiausaha Kerajaan Negeri (Pentadbiran)">Pejabat Timbalan Setiausaha Kerajaan Negeri (Pentadbiran)</option><option value="Pejabat Timbalan Setiausaha Kerajaan Negeri (Pembangunan)">Pejabat Timbalan Setiausaha Kerajaan Negeri (Pembangunan)</option><option value="Jabatan Arkib Negeri Sabah">Jabatan Arkib Negeri Sabah</option><option value="Jabatan Peguam Besar Negeri">Jabatan Peguam Besar Negeri</option><option value="Jabatan Cetak Kerajaan">Jabatan Cetak Kerajaan</option><option value="Jabatan Perkhidmatan Awam Negeri">Jabatan Perkhidmatan Awam Negeri</option><option value="Jabatan Tanah &amp; Ukur">Jabatan Tanah &amp; Ukur</option><option value="Jabatan Perhutanan Sabah">Jabatan Perhutanan Sabah</option><option value="Jabatan Hal Ehwal Agama Islam Negeri Sabah">Jabatan Hal Ehwal Agama Islam Negeri Sabah</option><option value="Unit Perancang Ekonomi Negeri">Unit Perancang Ekonomi Negeri</option><option value="Unit Pemimpin Pembangunan Masyarakat">Unit Pemimpin Pembangunan Masyarakat</option><option value="Pejabat Perhubungan Negeri Sabah">Pejabat Perhubungan Negeri Sabah</option><option value="Bahagian Istiadat dan Protokol">Bahagian Istiadat dan Protokol</option><option value="Bahagian Pengurusan dan Kewangan">Bahagian Pengurusan dan Kewangan</option><option value="Bahagian Kabinet dan Dasar">Bahagian Kabinet dan Dasar</option><option value="Pejabat Akhbar dan Penerbitan">Pejabat Akhbar dan Penerbitan</option><option value="Pejabat Mufti Negeri">Pejabat Mufti Negeri</option><option value="Pejabat Hasil Bumi">Pejabat Hasil Bumi</option><option value="Pejabat Hal Ehwal Dalam Negeri dan Penyelidikan">Pejabat Hal Ehwal Dalam Negeri dan Penyelidikan</option><option value="Jabatan Bendahari Negeri">Jabatan Bendahari Negeri</option><option value="Jabatan Perkhidmatan Komputer Negeri">Jabatan Perkhidmatan Komputer Negeri</option><option value="Jabatan Perikanan">Jabatan Perikanan</option><option value="Jabatan Perkhidmatan Veterinar Sabah">Jabatan Perkhidmatan Veterinar Sabah</option><option value="Jabatan Pengairan dan Saliran">Jabatan Pengairan dan Saliran</option><option value="Jabatan Pertanian">Jabatan Pertanian</option><option value="Jabatan Air Negeri Sabah">Jabatan Air Negeri Sabah</option><option value="Jabatan Perkhidmatan Pembetungan Sabah">Jabatan Perkhidmatan Pembetungan Sabah</option><option value="Jabatan Kerja Raya">Jabatan Kerja Raya</option><option value="Jabatan Keretapi Negeri Sabah">Jabatan Keretapi Negeri Sabah</option><option value="Jabatan Pelabuhan dan Dermaga Sabah">Jabatan Pelabuhan dan Dermaga Sabah</option><option value="Jabatan Perancang Bandar dan Wilayah">Jabatan Perancang Bandar dan Wilayah</option><option value="Jabatan Hal Ehwal Anak Negeri Sabah">Jabatan Hal Ehwal Anak Negeri Sabah</option><option value="Jabatan Perkhidmatan Kebajikan Am">Jabatan Perkhidmatan Kebajikan Am</option><option value="Jabatan Hal Ehwal Wanita Negeri">Jabatan Hal Ehwal Wanita Negeri</option><option value="Jabatan Hidupan Liar">Jabatan Hidupan Liar</option><option value="Jabatan Perlindungan Alam Sekitar">Jabatan Perlindungan Alam Sekitar</option><option value="Jabatan Muzium Sabah">Jabatan Muzium Sabah</option><option value="Jabatan Pembangunan Perindustrian dan Penyelidikan">Jabatan Pembangunan Perindustrian dan Penyelidikan</option><option value="Perpustakaan Negeri Sabah">Perpustakaan Negeri Sabah</option><option value="Jabatan Pembangunan Sumber Manusia">Jabatan Pembangunan Sumber Manusia</option><option value="Pejabat Daerah Putatan">Pejabat Daerah Putatan</option> <option value="Pejabat Daerah Kecil Paitan">Pejabat Daerah Kecil Paitan</option> <option value="Pejabat Daerah Kecil Pagalungan">Pejabat Daerah Kecil Pagalungan</option> <option value="Pejabat Daerah Kecil Tungku">Pejabat Daerah Kecil Tungku</option> <option value="Pejabat Daerah Telupid">Pejabat Daerah Telupid</option> <option value="Pejabat Daerah Kecil Banggi">Pejabat Daerah Kecil Banggi</option> <option value="Pejabat Daerah Kecil Tamparuli">Pejabat Daerah Kecil Tamparuli</option> <option value="Pejabat Daerah Kecil Menumbok">Pejabat Daerah Kecil Menumbok</option> <option value="Pejabat Daerah Kecil Membakut">Pejabat Daerah Kecil Membakut</option> <option value="Pejabat Daerah Kecil Matunggong">Pejabat Daerah Kecil Matunggong</option> <option value="Pejabat Daerah Kecil Sook">Pejabat Daerah Kecil Sook</option> <option value="Pejabat Daerah Kecil Kemabong">Pejabat Daerah Kecil Kemabong</option> <option value="Pejabat Daerah Penampang">Pejabat Daerah Penampang</option> <option value="Pejabat Daerah Papar">Pejabat Daerah Papar</option> <option value="Pejabat Daerah Tuaran">Pejabat Daerah Tuaran</option> <option value="Pejabat Daerah Kota Belud">Pejabat Daerah Kota Belud</option> <option value="Pejabat Daerah Ranau">Pejabat Daerah Ranau</option> <option value="Pejabat Daerah Kudat">Pejabat Daerah Kudat</option> <option value="Pejabat Daerah Kota Marudu">Pejabat Daerah Kota Marudu</option> <option value="Pejabat Daerah Pitas">Pejabat Daerah Pitas</option> <option value="Pejabat Daerah Keningau">Pejabat Daerah Keningau</option> <option value="Pejabat Daerah Tambunan">Pejabat Daerah Tambunan</option> <option value="Pejabat Daerah Nabawan">Pejabat Daerah Nabawan</option> <option value="Pejabat Daerah Sipitang">Pejabat Daerah Sipitang</option> <option value="Pejabat Daerah Tenom">Pejabat Daerah Tenom</option> <option value="Pejabat Daerah Beaufort">Pejabat Daerah Beaufort</option> <option value="Pejabat Daerah Kuala Penyu">Pejabat Daerah Kuala Penyu</option> <option value="Pejabat Daerah Kinabatangan">Pejabat Daerah Kinabatangan</option> <option value="Pejabat Daerah Beluran">Pejabat Daerah Beluran</option> <option value="Pejabat Daerah Semporna">Pejabat Daerah Semporna</option> <option value="Pejabat Daerah Lahad Datu">Pejabat Daerah Lahad Datu</option> <option value="Pejabat Daerah Kunak">Pejabat Daerah Kunak</option> <option value="Pejabat Daerah Tongod">Pejabat Daerah Tongod</option> <option value="Pejabat Daerah Kalabakan">Pejabat Daerah Kalabakan</option> <option value="Dewan Bandaraya Kota Kinabalu">Dewan Bandaraya Kota Kinabalu</option> <option value="Majlis Perbandaran Sandakan">Majlis Perbandaran Sandakan</option> <option value="Majlis Perbandaran Tawau">Majlis Perbandaran Tawau</option> <option value="Majlis Daerah Beaufort">Majlis Daerah Beaufort</option> <option value="Majlis Daerah Beluran">Majlis Daerah Beluran</option> <option value="Majlis Daerah Keningau">Majlis Daerah Keningau</option> <option value="Majlis Daerah Kinabatangan">Majlis Daerah Kinabatangan</option> <option value="Majlis Daerah Tongod">Majlis Daerah Tongod</option> <option value="Majlis Daerah Telupid">Majlis Daerah Telupid</option> <option value="Majlis Daerah Putatan">Majlis Daerah Putatan</option> <option value="Majlis Daerah Kota Belud">Majlis Daerah Kota Belud</option> <option value="Majlis Daerah Kota Marudu">Majlis Daerah Kota Marudu</option> <option value="Majlis Daerah Kuala Penyu">Majlis Daerah Kuala Penyu</option> <option value="Majlis Daerah Kunak">Majlis Daerah Kunak</option> <option value="Majlis Daerah Lahad Datu">Majlis Daerah Lahad Datu</option> <option value="Majlis Daerah Nabawan">Majlis Daerah Nabawan</option> <option value="Majlis Daerah Papar">Majlis Daerah Papar</option> <opt ion value="Majlis Daerah Penampang">Majlis Daerah Penampang</option> <option value="Majlis Daerah Ranau">Majlis Daerah Ranau</option> <option value="Majlis Daerah Semporna">Majlis Daerah Semporna</option> <option value="Majlis Daerah Sipitang">Majlis Daerah Sipitang</option> <option value="Majlis Daerah Tambunan">Majlis Daerah Tambunan</option> <option value="Majlis Daerah Tenom">Majlis Daerah Tenom</option> <option value="Majlis Daerah Tuaran">Majlis Daerah Tuaran</option> <option value="Lembaga Bandaran Kudat">Lembaga Bandaran Kudat</option> <option value="Majlis Daerah Pitas">Majlis Daerah Pitas</option> <option value="Majlis Ugama Islam Sabah (MUIS)">Majlis Ugama Islam Sabah (MUIS)</option> <option value="Lembaga Kemajuan Perhutanan Negeri Sabah (SAFODA)">Lembaga Kemajuan Perhutanan Negeri Sabah (SAFODA)</option> <option value="Perbadanan Baitulmal Negeri Sabah">Perbadanan Baitulmal Negeri Sabah</option> <option value="Lembaga Industri Getah Sabah">Lembaga Industri Getah Sabah</option> <option value="Korporasi Pembangunan Desa (KPD)">Korporasi Pembangunan Desa (KPD)</option> <option value="Korporasi Kemajuan Perikanan dan Nelayan Sabah (KONELAYAN)">Korporasi Kemajuan Perikanan dan Nelayan Sabah (KONELAYAN)</option> <option value="Lembaga Pelabuhan-Pelabuhan Sabah">Lembaga Pelabuhan-Pelabuhan Sabah</option> <option value="Lembaga Pembangunan Perumahan dan Bandar">Lembaga Pembangunan Perumahan dan Bandar</option> <option value="Lembaga Pemegang Amanah Taman-Taman Sabah">Lembaga Pemegang Amanah Taman-Taman Sabah</option> <option value="Lembaga Pelancongan Sabah">Lembaga Pelancongan Sabah</option> <option value="Lembaga Kebudayaan Negeri Sabah">Lembaga Kebudayaan Negeri Sabah</option> <option value="Perbadanan Pembangunan Ekonomi Negeri Sabah (SEDCO)">Perbadanan Pembangunan Ekonomi Negeri Sabah (SEDCO)</option> <option value="Lembaga Sukan Negeri Sabah">Lembaga Sukan Negeri Sabah</option>
                        @else
                           <option value="{{$userData[0]->agensi}}">[Pilihan] - {{$userData[0]->agensi}}</option><option value="Pejabat Yang Dipertua Negeri Sabah / Istana Negeri">Pejabat Yang Dipertua Negeri Sabah / Istana Negeri</option><option value="Pejabat Ketua Menteri">Pejabat Ketua Menteri</option><option value="Pejabat Setiausaha Kerajaan Negeri">Pejabat Setiausaha Kerajaan Negeri</option><option value="Kementerian Pembangunan Luar Bandar">Kementerian Pembangunan Luar Bandar</option><option value="Kementerian Kewangan">Kementerian Kewangan</option><option value="Kementerian Pertanian dan Perikanan">Kementerian Pertanian dan Perikanan</option><option value="Kementerian Kerja Raya">Kementerian Kerja Raya</option><option value="Kementerian Kerajaan Tempatan dan Perumahan">Kementerian Kerajaan Tempatan dan Perumahan</option><option value="Kementerian Pembangunan Masyarakat dan Kesejahteraan Rakyat">Kementerian Pembangunan Masyarakat dan Kesejahteraan Rakyat</option><option value="Kementerian Pelancongan, Kebudayaan dan Alam Sekitar">Kementerian Pelancongan, Kebudayaan dan Alam Sekitar</option><option value="Kementerian Pembangunan Perindustrian">Kementerian Pembangunan Perindustrian</option><option value="Kementerian Belia dan Sukan Sabah">Kementerian Belia dan Sukan Sabah</option><option value="Kementerian Sains, Teknologi dan Inovasi">Kementerian Sains, Teknologi dan Inovasi</option><option value="Pejabat Dewan Undangan Negeri">Pejabat Dewan Undangan Negeri</option><option value="Suruhanjaya Perkhidmatan Awam Negeri">Suruhanjaya Perkhidmatan Awam Negeri</option><option value="Pejabat Timbalan Setiausaha Kerajaan Negeri (Pentadbiran)">Pejabat Timbalan Setiausaha Kerajaan Negeri (Pentadbiran)</option><option value="Pej
tongod</option> <option value="Pejabat Daerah Kalabakan">Pejabat Daerah Kalabakan</option> <option value="Dewan Bandaraya Kota Kinabalu">Dewan Bandaraya Kota Kinabalu</option> <option value="Majlis Perbandaran Sandakan">Majlis Perbandaran Sandakan</option> <option value="Majlis Perbandaran Tawau">Majlis Perbandaran Tawau</option> <option value="Majlis Daerah Beaufort">Majlis Daerah Beaufort</option> <option value="Majlis Daerah Beluran">Majlis Daerah Beluran</option> <option value="Majlis Daerah Keningau">Majlis Daerah Keningau</option> <option value="Majlis Daerah Kinabatangan">Majlis Daerah Kinabatangan</option> <option value="Majlis Daerah Tongod">Majlis Daerah Tongod</option> <option value="Majlis Daerah Telupid">Majlis Daerah Telupid</option> <option value="Majlis Daerah Putatan">Majlis Daerah Putatan</option> <option value="Majlis Daerah Kota Belud">Majlis Daerah Kota Belud</option> <option value="Majlis Daerah Kota Marudu">Majlis Daerah Kota Marudu</option> <option value="Majlis Daerah Kuala Penyu">Majlis Daerah Kuala Penyu</option> <option value="Majlis Daerah Kunak">Majlis Daerah Kunak</option> <option value="Majlis Daerah Lahad Datu">Majlis Daerah Lahad Datu</option> <option value="Majlis Daerah Nabawan">Majlis Daerah Nabawan</option> <option value="Majlis Daerah Papar">Majlis Daerah Papar</option> <option value="Majlis Daerah Penampang">Majlis Daerah Penampang</option> <option value="Majlis Daerah Ranau">Majlis Daerah Ranau</option> <option value="Majlis Daerah Semporna">Majlis Daerah Semporna</option> <option value="Majlis Daerah Sipitang">Majlis Daerah Sipitang</option> <option value="Majlis Daerah Tambunan">Majlis Daerah Tambunan</option> <option value="Majlis Daerah Tenom">Majlis Daerah Tenom</option> <option value="Majlis Daerah Tuaran">Majlis Daerah Tuaran</option> <option value="Lembaga Bandaran Kudat">Lembaga Bandaran Kudat</option> <option value="Majlis Daerah Pitas">Majlis Daerah Pitas</option> <option value="Majlis Ugama Islam Sabah (MUIS)">Majlis Ugama Islam Sabah (MUIS)</option> <option value="Lembaga Kemajuan Perhutanan Negeri Sabah (SAFODA)">Lembaga Kemajuan Perhutanan Negeri Sabah (SAFODA)</option> <option value="Perbadanan Baitulmal Negeri Sabah">Perbadanan Baitulmal Negeri Sabah</option> <option value="Lembaga Industri Getah Sabah">Lembaga Industri Getah Sabah</option> <option value="Korporasi Pembangunan Desa (KPD)">Korporasi Pembangunan Desa (KPD)</option> <option value="Korporasi Kemajuan Perikanan dan Nelayan Sabah (KONELAYAN)">Korporasi Kemajuan Perikanan dan Nelayan Sabah (KONELAYAN)</option> <option value="Lembaga Pelabuhan-Pelabuhan Sabah">Lembaga Pelabuhan-Pelabuhan Sabah</option> <option value="Lembaga Pembangunan Perumahan dan Bandar">Lembaga Pembangunan Perumahan dan Bandar</option> <option value="Lembaga Pemegang Amanah Taman-Taman Sabah">Lembaga Pemegang Amanah Taman-Taman Sabah</option> <option value="Lembaga Pelancongan Sabah">Lembaga Pelancongan Sabah</option> <option value="Lembaga Kebudayaan Negeri Sabah">Lembaga Kebudayaan Negeri Sabah</option> <option value="Perbadanan Pembangunan Ekonomi Negeri Sabah (SEDCO)">Perbadanan Pembangunan Ekonomi Negeri Sabah (SEDCO)</option> <option value="Lembaga Sukan Negeri Sabah">Lembaga Sukan Negeri Sabah</option>
                        @endif
                     </select>
                     </div>
                  ...
                  <div class="introPage <x-form-validation-error :key='$userData[0]->filledA' :index='$userData[0]->tarafJawatan'/>" style="margin-bottom: 10px;">
                     ...
                     <input {{$userProgress[0]->completedR == 1 ? 'disabled' : ''}} id="sementara" type="radio" name="tarafJawatan" value="Sementara" {{ $userData[0]->tarafJawatan == 'Sementara' ? 'checked' : '' }}>
                  ...
                  <div class="introPage <x-form-validation-error :key='$userData[0]->filledA' :index='$userData[0]->tempatTinggal'/>" style="margin-bottom: 10px;">
                     ...
                     <input {{$userProgress[0]->completedR == 1 ? 'disabled' : ''}} type="radio" onclick="clearInput('inputTempatTinggal')" id="RumahSewa" name="tempatTinggal" value="Rumah Sewa" {{ $userData[0]->tempatTinggal == 'Rumah Sewa' ? 'checked' : '' }}>
                     <label class="inBlock" for="RumahSewa">Rumah Sewa</label><br>
                     <input {{$userProgress[0]->completedR == 1 ? 'disabled' : ''}} type="radio" onclick="clearInput('inputTempatTinggal')" id="BilikSewa" name="tempatTinggal" value="Bilik Sewa" {{ $userData[0]->tempatTinggal == 'Bilik Sewa' ? 'checked' : '' }}>
                  ...
                  <div class="introPage <x-form-validation-error :key='$userData[0]->filledA' :index='$userData[0]->tinggalBersama'/>" style="margin-bottom: 10px;">
                     ...
                     <input {{$userProgress[0]->completedR == 1 ? 'disabled' : ''}} type="radio" onclick="clearInput('inputTinggalBersama')" id="BersamaKeluargaMertua" name="tinggalBersama" value="Bersama Keluarga Mertua" {{ $userData[0]->tinggalBersama == 'Bersama Keluarga Mertua' ? 'checked' : '' }}>
                     <label class="inBlock" for="BersamaKeluargaMertua">Bersama Keluarga Mertua</label><br>
                     <input {{$userProgress[0]->completedR == 1 ? 'disabled' : ''}} type="radio" id="hbsi" onclick="clearInput('inputTinggalBersama')" name="tinggalBersama" value="Hanya Bersama Suami/Isteri dan Anak" {{ $userData[0]->tinggalBersama == 'Hanya Bersama Suami/Isteri dan Anak' ? 'checked' : '' }}>
                     <label class="inBlock" for="hbsi">Hanya Bersama Suami/Isteri dan Anak</label><br>
                     <input {{$userProgress[0]->completedR == 1 ? 'disabled' : ''}} type="radio" id="tjdp" onclick="clearInput('inputTinggalBersama')" name="tinggalBersama" value="Tinggal Berjauhan Dengan Pasangan" {{ $userData[0]->tinggalBersama == 'Tinggal Berjauhan Dengan Pasangan' ? 'checked' : '' }}>
                  ...
                  <div class="introPage <x-form-validation-error :key='$userData[0]->filledA' :index='$userData[0]->kenderaanKerja'/>" style="margin-bottom: 10px;">
                     ...
                     <input {{$userProgress[0]->completedR == 1 ? 'disabled' : ''}} type="radio" onclick="clearInput('inputKenderaanKerja')" id="MenumpangRakan" name="kenderaanKerja" value="Menumpang Rakan" {{ $userData[0]->kenderaanKerja == 'Menumpang Rakan' ? 'checked' : '' }}>
                     <label class="inBlock" for="MenumpangRakan">Menumpang Rakan</label><br>
                     <input {{$userProgress[0]->completedR == 1 ? 'disabled' : ''}} type="radio" onclick="clearInput('inputKenderaanKerja')" id="ehailing" name="kenderaanKerja" value="e-Hailing" {{ $userData[0]->kenderaanKerja == 'e-Hailing' ? 'checked' : '' }}>
                     <label class="inBlock" for="ehailing">e-Hailing</label><br>
                     <input {{$userProgress[0]->completedR == 1 ? 'disabled' : ''}} type="radio" onclick="clearInput('inputKenderaanKerja')" id="BasTeksi" name="kenderaanKerja" value="Bas Teksi" {{ $userData[0]->kenderaanKerja == 'Bas Teksi' ? 'checked' : '' }}>
                  ...
                  <div class="introPage <x-form-validation-error :key='$userData[0]->filledA' :index='$userData[0]->tempohPerkhidmatanTahun'/> <x-form-validation-error :key='$userData[0]->filledA' :index='$userData[0]->tempohPerkhidmatanBulan'/>" style="margin-bottom: 10px;">
                     ...
                     tahun
                     <select {{$userProgress[0]->completedR == 1 ? 'disabled' : ''}} name="tempohPerkhidmatanBulan" class="selectBox">
                  ...
                  <div class="introPage <x-form-validation-error :key='$userData[0]->filledA' :index='$userData[0]->penilai'/>" style="margin-bottom: 10px;">
                     ...
                     <input {{$userProgress[0]->completedR == 1 ? 'disabled' : ''}} style="margin-left: 15px" type="radio" id="penilai2" name="penilai" value="2" {{ $userData[0]->penilai == '2' ? 'checked' : ''}}>
