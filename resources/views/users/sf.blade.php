...
<div class="contents eight columns">
    ...
    <form action="{{route('updateSectionF')}}" method="POST">
            ...
            <div class="introPage <x-form-validation-error key='F1'/>" style="margin-bottom: 10px;">
                ...
                <x-ratings-components initialQuestion="0" :completedR="$userProgress[0]->completedR" questionNumber="1" sectionQuestion="F" :userData="$userData[0]->F1"/>
             </div>
             <div class="introPage <x-form-validation-error key='F2'/>" style="margin-bottom: 10px;">
                ...
                <x-ratings-components initialQuestion="0" :completedR="$userProgress[0]->completedR" questionNumber="2" sectionQuestion="F" :userData="$userData[0]->F2"/>
             </div>
             <div class="introPage <x-form-validation-error key='F3'/>" style="margin-bottom: 10px;">
                <p>3. Saya bersemangat dengan kerja saya.</p>
                <x-ratings-components initialQuestion="0" :completedR="$userProgress[0]->completedR" questionNumber="3" sectionQuestion="F" :userData="$userData[0]->F3"/>
             </div>
             <div class="introPage <x-form-validation-error key='F4'/>" style="margin-bottom: 10px;">
                ...
                <x-ratings-components initialQuestion="0" :completedR="$userProgress[0]->completedR" questionNumber="4" sectionQuestion="F" :userData="$userData[0]->F4"/>
             </div>
             <div class="introPage <x-form-validation-error key='F5'/>" style="margin-bottom: 10px;">
                ...
                <x-ratings-components initialQuestion="0" :completedR="$userProgress[0]->completedR" questionNumber="5" sectionQuestion="F" :userData="$userData[0]->F5"/>
             </div>
             <div class="introPage <x-form-validation-error key='F6'/>" style="margin-bottom: 10px;">
                ...
                <x-ratings-components initialQuestion="0" :completedR="$userProgress[0]->completedR" questionNumber="6" sectionQuestion="F" :userData="$userData[0]->F6"/>
             </div>
