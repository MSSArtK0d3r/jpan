...
<div class="contents eight columns">
    ...
    <form action="{{route('updateSectionH4')}}" method="POST">
        @csrf
        <div class="introPage <x-form-validation-error :key='$userData[0]->filledH4' :index='$userData[0]->H30'/>" style="margin-bottom: 10px;">
        ...
        <div class="introPage <x-form-validation-error :key='$userData[0]->filledH4' :index='$userData[0]->H31'/>" style="margin-bottom: 10px;">
         ...
         <div class="introPage <x-form-validation-error :key='$userData[0]->filledH4' :index='$userData[0]->H32'/>" style="margin-bottom: 10px;">
            <p>32. Warga organisasi sentiasa terlibat dalam proses-proses dan peristiwa utama.</p>
            <x-ratings-components initialQuestion="0"  questionNumber="32" sectionQuestion="H" :userData="$userData[0]->H32"/> 
         </div>
         <div class="introPage <x-form-validation-error :key='$userData[0]->filledH4' :index='$userData[0]->H33'/>" style="margin-bottom: 10px;">
            <p>33. Pengurusan organisasi tidak menghukum kesilapan dan menggalakkan pengalaman dan pembelajaran.</p>
            <x-ratings-components initialQuestion="0"  questionNumber="33" sectionQuestion="H" :userData="$userData[0]->H33"/> 
         </div>
         <div class="introPage <x-form-validation-error :key='$userData[0]->filledH4' :index='$userData[0]->H34'/>" style="margin-bottom: 10px;">
            <p>34. Pengurusan organisasi saya mengalu-alukan perubahan.</p>
            <x-ratings-components initialQuestion="0"  questionNumber="34" sectionQuestion="H" :userData="$userData[0]->H34"/> 
         </div>
         <div class="introPage <x-form-validation-error :key='$userData[0]->filledH4' :index='$userData[0]->H35'/>" style="margin-bottom: 10px;">
