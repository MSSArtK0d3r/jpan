...
<div class="contents eight columns">
    ...
    <form action="{{route('updateSectionH4')}}" method="POST">
        ...
        <x-ratings-components initialQuestion="0" :completedR="userData[0]->completedR" questionNumber="30" sectionQuestion="H" :userData="$userData[0]->H30"/> 
         </div>
        <div class="introPage <x-form-validation-error key='H31'/>" style="margin-bottom: 10px;">
            ...
            <x-ratings-components initialQuestion="0" :completedR="userData[0]->completedR" questionNumber="31" sectionQuestion="H" :userData="$userData[0]->H31"/> 
         </div>
         <div class="introPage <x-form-validation-error key='H32'/>" style="margin-bottom: 10px;">
            ...
            <x-ratings-components initialQuestion="0" :completedR="userData[0]->completedR" questionNumber="32" sectionQuestion="H" :userData="$userData[0]->H32"/> 
         </div>
         <div class="introPage <x-form-validation-error key='H33'/>" style="margin-bottom: 10px;">
            ...
            <x-ratings-components initialQuestion="0" :completedR="userData[0]->completedR" questionNumber="33" sectionQuestion="H" :userData="$userData[0]->H33"/> 
         </div>
         <div class="introPage <x-form-validation-error key='H34'/>" style="margin-bottom: 10px;">
            ...
            <x-ratings-components initialQuestion="0" :completedR="userData[0]->completedR" questionNumber="34" sectionQuestion="H" :userData="$userData[0]->H34"/> 
         </div>
         <div class="introPage <x-form-validation-error key='H35'/>" style="margin-bottom: 10px;">
            ...
            <x-ratings-components initialQuestion="0" :completedR="userData[0]->completedR" questionNumber="35" sectionQuestion="H" :userData="$userData[0]->H35"/> 
         </div>
