    ...
    <form action="{{route('updateSectionH2')}}" method="POST">
        @csrf
         <div class="introPage <x-form-validation-error key='H13'/>" style="margin-bottom: 10px;">
            ...
            <x-ratings-components initialQuestion="0" :completedR="$userProgress[0]->completedR" questionNumber="13" sectionQuestion="H" :userData="$userData[0]->H13"/> 
         </div>
         <div class="introPage <x-form-validation-error key='H14'/>" style="margin-bottom: 10px;">
            ...
            <x-ratings-components initialQuestion="0" :completedR="$userProgress[0]->completedR" questionNumber="14" sectionQuestion="H" :userData="$userData[0]->H14"/> 
         </div>
         <div class="introPage <x-form-validation-error key='H15'/>" style="margin-bottom: 10px;">
            ...
            <x-ratings-components initialQuestion="0" :completedR="$userProgress[0]->completedR" questionNumber="15" sectionQuestion="H" :userData="$userData[0]->H15"/> 
         </div>
         <div class="introPage <x-form-validation-error key='H16'/>" style="margin-bottom: 10px;">
            <p>16. Proses/sistem kerja diselaraskan.</p>
            <x-ratings-components initialQuestion="0" :completedR="$userProgress[0]->completedR" questionNumber="16" sectionQuestion="H" :userData="$userData[0]->H16"/> 
         </div>
         <div class="introPage <x-form-validation-error key='H17'/>" style="margin-bottom: 10px;">
            ...
            <x-ratings-components initialQuestion="0" :completedR="$userProgress[0]->completedR" questionNumber="17" sectionQuestion="H" :userData="$userData[0]->H17"/> 
         </div>
         <div class="introPage <x-form-validation-error key='H18'/>" style="margin-bottom: 10px;">
            ...
            <x-ratings-components initialQuestion="0" :completedR="$userProgress[0]->completedR" questionNumber="18" sectionQuestion="H" :userData="$userData[0]->H18"/> 
         </div>
         <div class="introPage <x-form-validation-error key='H19'/>" style="margin-bottom: 10px;">
            ...
            <x-ratings-components initialQuestion="0" :completedR="$userProgress[0]->completedR" questionNumber="19" sectionQuestion="H" :userData="$userData[0]->H19"/> 
         </div>
         <div class="introPage <x-form-validation-error key='H20'/>" style="margin-bottom: 10px;">
            ...
            <x-ratings-components initialQuestion="0" :completedR="$userProgress[0]->completedR" questionNumber="20" sectionQuestion="H" :userData="$userData[0]->H20"/> 
         </div>
